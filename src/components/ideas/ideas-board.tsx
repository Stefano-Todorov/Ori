      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            Ideas
            <InfoTooltip text="Your video idea backlog. Add ideas manually, from AI coach suggestions, or from saved inspiration. Track each idea from concept through recording, editing, and posting." />
          </h2>
        ...
        {filtered.length === 0 ? (
          ideas.length === 0 ? (
            <EmptyState
              icon={Lightbulb}
              title="No ideas yet"
              description="Collect video ideas from your AI coach, saved inspiration, or add your own. Track them from concept to posted."
