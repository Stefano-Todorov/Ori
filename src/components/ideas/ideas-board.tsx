  ...
  return (
    <>
      ...
      <Dialog open={editOpen} onOpenChange={(v) => { setEditOpen(v); if (!v) setEditingId(null) }}>
        <DialogContent className="!w-[70vw] !max-w-[70vw] !flex !flex-col max-h-[80vh] overflow-y-auto bg-background border-border rounded-2xl p-6 shadow-[0_0_40px_rgba(124,58,237,0.1)]">
          <DialogHeader>
