      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <ul className="text-muted-foreground space-y-2 list-disc list-inside leading-relaxed">
            ...
            <li><strong>Permissions used:</strong> The extension uses <em>activeTab</em> (to read the current page when you click Save), <em>storage</em> (to store your login session locally), <em>tabs</em> (to detect when you&apos;re on a supported site), <em>scripting</em> (to extract post data from the page), and <em>downloads</em> (to save a video file to your device when you click the &quot;Download&quot; button). It only runs on tiktok.com and instagram.com.</li>
            <li><strong>Data sent to our servers:</strong> When you save a post, the extracted metadata is sent to Orianna&apos;s servers and stored in your account as part of your swipe file. When you click &quot;Download&quot; on a post, the public post URL is sent to our server, which resolves it to a direct video URL so the file can be downloaded to your device — the video itself is not stored on our servers. No data is collected passively or in the background — the extension only acts when you interact with it.</li>
